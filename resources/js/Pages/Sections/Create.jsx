...
export default function Create() {
    const { data, setData, post, processing } = useForm({ label: '' });
    return (
        <AppLayout title="Add New Section">
            <div className="bg-white shadow-sm sm:rounded-lg p-6">
                <form onSubmit={(e) => { e.preventDefault(); post('/sections'); }} className="space-y-4 max-w-2xl">
