...
<div class="p-6">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="text-center mb-8">
            <h1 class="text-4xl font-bold bg-blue-500 bg-clip-text text-transparent mb-2">
        ...
        <div class="bg-white rounded-xl shadow-lg border border-slate-200 p-8 mb-6">
            <form wire:submit.prevent="verify" class="space-y-4">
                ...
                <button 
                    type="submit"
                    class="w-full px-6 py-3 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-all shadow-md hover:shadow-lg text-lg font-medium"
                >
                    Verify Certificate
                </button>
            </form>
