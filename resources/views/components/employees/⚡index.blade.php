...
<div class="p-6">
    ...
    <!-- Edit Employee Modal -->
    @if($editMode)
    <div class="fixed inset-0 bg-black/40 overflow-y-auto h-full w-full z-50 p-4" wire:click.self="cancelEdit">
        <div class="relative top-10 mx-auto p-6 border w-full max-w-2xl shadow-lg rounded-xl bg-white overflow-hidden">
