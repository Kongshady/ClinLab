...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-lg shadow-md p-6">
            <h1 class="text-2xl font-bold mb-6">Edit Lab Test</h1>
            ...
            <form action="{{ route('tests.update', $test) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    >
                        ...
                        @foreach($sections as $section)
                            <option value="{{ $section->section_id }}" {{ old('section_id', $test->section_id) == $section->section_id ? 'selected' : '' }}>
                                {{ $section->label }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="mb-4">
                    ...
                    <input 
                        ...
                        name="current_price" 
                        id="current_price" 
                        value="{{ old('current_price', $test->current_price) }}"
                        step="0.01"
                        min="0"
                        max="99999999.99"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
