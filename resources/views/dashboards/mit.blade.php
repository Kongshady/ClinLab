    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 mb-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                @can('tests.access')
                <a href="{{ route('tests.index') }}" class="flex flex-col items-center p-4 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors">
                ...
                <a href="{{ route('employees.index') }}" class="flex flex-col items-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                ...
                <a href="{{ route('equipment.index') }}" class="flex flex-col items-center p-4 bg-cyan-50 rounded-lg hover:bg-cyan-100 transition-colors">
                ...
                <a href="{{ route('permissions.index') }}" class="flex flex-col items-center p-4 bg-red-50 rounded-lg hover:bg-red-100 transition-colors">
                ...
                @can('roles.access')
                <a href="{{ route('roles.index') }}" class="flex flex-col items-center p-4 bg-orange-50 rounded-lg hover:bg-orange-100 transition-colors">
