...
<div class="p-8 space-y-6 bg-gray-50 min-h-screen">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-gray-600 mt-1">Manage laboratory inventory items</p>
        </div>
        @can('items.create')
        <a href="{{ route('items.create') }}" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-sm font-medium transition-colors">
            + Add Item
        </a>
        @endcan
    </div>
    ...
    <div class="bg-white rounded-lg shadow border border-gray-200">
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center justify-between">
                ...
                <div class="text-sm text-gray-600">Total: <span class="font-semibold">{{ $items->total() }}</span></div>
            </div>
        </div>
            ...
            <table class="w-full">
                <thead class="bg-gray-50 border-b border-gray-200">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Item Name</th>
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $item->unit ?: 'pcs' }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $item->reorder_level }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                            <div class="flex items-center space-x-2">
                                @can('items.edit')
                                <a href="{{ route('items.edit', $item) }}" class="text-green-600 hover:text-green-800" title="Edit">
