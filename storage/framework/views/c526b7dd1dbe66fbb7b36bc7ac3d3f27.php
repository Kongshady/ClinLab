            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 border-t border-gray-200">
                    ...
                    <div>
                        ...
                        <p class="text-base text-gray-900"><?php echo e(ucfirst(str_replace('_', ' ', auth()->user()->roles->first()->name ?? 'User'))); ?></p>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\dashboard\clinlab_app\resources\views/account-settings.blade.php ENDPATH**/ ?>