                ...
                <div class="flex items-center gap-3">
                    <div class="flex items-center gap-2">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->avatar): ?>
                            <img src="<?php echo e(auth()->user()->avatar); ?>" alt="Avatar" class="w-7 h-7 rounded-full ring-2 ring-white/30">
                        <?php else: ?>
                        ...
                        <span class="text-sm font-medium text-white/90 hidden sm:block"><?php echo e(auth()->user()->name); ?></span>
                    </div>
