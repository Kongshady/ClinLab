                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div class="space-y-2">
                                    ...
                                    <div x-data="{
                                        ...
                                        <div @click="open = !open" class="w-full px-4 py-2.5 bg-white border border-gray-300 rounded-lg cursor-pointer flex items-center justify-between hover:border-emerald-400 transition-all" :class="open ? 'ring-2 ring-emerald-500 border-transparent' : ''">
                                            ...
                                            <div class="flex items-center space-x-1">
                                                <button x-show="selectedLabel" @click.stop="clear()" type="button" class="text-gray-400 hover:text-rose-500">
                                        ...
                                        <div x-show="open" x-transition.opacity class="absolute z-50 mt-1 w-full bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden">
                                            <div class="p-2 border-b border-gray-100">
                                                <input x-ref="searchInput" x-model="search" @keydown.escape="open = false" type="text" placeholder="Search items..." class="w-full px-3 py-2 text-sm border border-gray-200 rounded-md focus:ring-2 focus:ring-emerald-500 focus:border-transparent" @click.stop>
                                            </div>
                                            <ul class="max-h-48 overflow-y-auto">
                                                <template x-for="item in filtered" :key="item.id">
                                                    <li @click="select(item)" class="px-4 py-2.5 text-sm cursor-pointer hover:bg-emerald-50 text-gray-700 hover:text-emerald-700 transition-colors" x-text="item.label"></li>
                                                </template>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="space-y-2">
                                    ...
                                    <div x-data="{
                                        ...
                                        <div @click="open = !open" class="w-full px-4 py-2.5 bg-white border border-gray-300 rounded-lg cursor-pointer flex items-center justify-between hover:border-rose-400 transition-all" :class="open ? 'ring-2 ring-rose-500 border-transparent' : ''">
                                            <span x-show="selectedLabel" x-text="selectedLabel" class="text-gray-900 truncate"></span>
                                            <span x-show="!selectedLabel" class="text-gray-400">Select Item</span>
                                            <div class="flex items-center space-x-1">
                                                <button x-show="selectedLabel" @click.stop="clear()" type="button" class="text-gray-400 hover:text-rose-500">
                                        ...
                                        <div x-show="open" x-transition.opacity class="absolute z-50 mt-1 w-full bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden">
                                            <div class="p-2 border-b border-gray-100">
                                                <input x-ref="searchInput" x-model="search" @keydown.escape="open = false" type="text" placeholder="Search items..." class="w-full px-3 py-2 text-sm border border-gray-200 rounded-md focus:ring-2 focus:ring-rose-500 focus:border-transparent" @click.stop>
                                            </div>
                                            <ul class="max-h-48 overflow-y-auto">
                                                <template x-for="item in filtered" :key="item.id">
                                                    <li @click="select(item)" class="px-4 py-2.5 text-sm cursor-pointer hover:bg-rose-50 text-gray-700 hover:text-rose-700 transition-colors">
