                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-blue-100 text-sm mt-0.5">
                            Requested: <?php echo e($selectedOrder->order_date->format('F d, Y - h:i A')); ?>
            ...
            <div class="p-6 overflow-y-auto space-y-5 flex-1">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                    <div class="bg-gray-50 p-3.5 rounded-xl">
                        ...
                        <p class="text-sm font-semibold text-gray-900"><?php echo e($patient->full_name); ?></p>
                    </div>
                    <div class="bg-gray-50 p-3.5 rounded-xl">
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="divide-y divide-gray-100">
                                    ...
                                    <tr class="hover:bg-blue-50/30 transition-colors">
                                        <td class="px-4 py-3">
                                            <div class="text-sm font-semibold text-gray-900"><?php echo e($ot->test->label ?? 'Unknown Test'); ?></div>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ot->test && $ot->test->section): ?>
                                                <div class="text-xs text-gray-400"><?php echo e($ot->test->section->label); ?></div>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </td>
                                        <td class="px-4 py-3">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($result && $result->result_value): ?>
                                                <span class="text-sm font-semibold text-gray-900"><?php echo e($result->result_value); ?></span>
                                            <?php else: ?>
                                                <span class="text-sm text-gray-400 italic">Pending</span>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </td>
                                        <td class="px-4 py-3">
                                            <span class="text-sm text-gray-600"><?php echo e($result->normal_range ?? '—'); ?></span>
                                        </td>
                                        <td class="px-4 py-3">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($flag): ?>
                                                <span class="inline-flex items-center gap-1 px-2 py-0.5 text-xs font-semibold rounded-full <?php echo e($flagClass); ?>">
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($flag === 'High'): ?>
                                        ...
                                        <td class="px-4 py-3">
                                            <span class="text-xs text-gray-600"><?php echo e($result->remarks ?? ($result->findings ?? '—')); ?></span>
                                        </td>
                                        <td class="px-4 py-3">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($result): ?>
                                                ...
                                                ?>
                                                <span class="px-2 py-0.5 text-xs font-medium rounded-full <?php echo e($rsc); ?>"><?php echo e(ucfirst($result->status)); ?></span>
                                            <?php else: ?>
                ...
                <div class="bg-amber-50 border border-amber-200 rounded-xl p-4">
                    ...
                    <p class="text-sm text-amber-800"><?php echo e($selectedOrder->remarks); ?></p>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <?php
                    ...
                    $verifiers = $selectedOrder->orderTests
                        ...
                        ->unique()->values();
                ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($performers->isNotEmpty() || $verifiers->isNotEmpty()): ?>
                <div class="grid grid-cols-2 gap-3">
                    <?php if($performers->isNotEmpty()): ?>
                    <div class="bg-gray-50 p-3.5 rounded-xl">
                        <p class="text-xs font-medium text-gray-500 uppercase mb-1">Performed By</p>
                        <p class="text-sm font-medium text-gray-900"><?php echo e($performers->implode(', ')); ?></p>
                    </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($verifiers->isNotEmpty()): ?>
                    <div class="bg-gray-50 p-3.5 rounded-xl">
                        <p class="text-xs font-medium text-gray-500 uppercase mb-1">Verified By</p>
                        <p class="text-sm font-medium text-gray-900"><?php echo e($verifiers->implode(', ')); ?></p>
                    </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
