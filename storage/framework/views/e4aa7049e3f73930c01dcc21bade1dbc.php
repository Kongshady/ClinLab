    ...
    <div class="bg-white rounded-lg shadow border border-gray-200">
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center justify-between">
                ...
                <div class="text-sm text-gray-600">Total: <span class="font-semibold"><?php echo e($activityLogs->total()); ?></span></div>
            </div>
        </div>
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($log->activity_log_id); ?></td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                            <?php echo e($log->employee->firstname ?? 'System'); ?> <?php echo e($log->employee->lastname ?? ''); ?>

                        </td>
                        <td class="px-6 py-4 text-sm text-gray-900"><?php echo e($log->description); ?></td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                            <?php echo e(\Carbon\Carbon::parse($log->datetime_added)->format('M d, Y h:i A')); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activityLogs->hasPages()): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\dashboard\clinlab_app\resources\views/activity-logs/index.blade.php ENDPATH**/ ?>